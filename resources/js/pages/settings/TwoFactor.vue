...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head :title="t('settings.two_factor')" />
        <SettingsLayout>
            <div class="space-y-6">
                <HeadingSmall
                    :title="t('settings.two_factor')"
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        {{ t('settings.two_factor_disabled_info') }}
                    </p>
                    ...
                    <div>
                        ...
                        >
                            <ShieldCheck />{{ t('settings.continue_setup') }}
                        </Button>
                        <Form
                            v-else
                            v-bind="enable.form()"
                        ...
                        >
                            <Button type="submit" :disabled="processing">
                                <ShieldCheck />{{ t('settings.enable_2fa') }}</Button
                            ></Form
                        >
                    </div>
                </div>
                ...
                >
                    ...
                    <p class="text-muted-foreground">
                        {{ t('settings.two_factor_enabled_info') }}
                    </p>
